...
<label for="pssNueva1">Ingrese Nueva Contraseña</label>
<input type= "password" name="pssNueva1" maxlenght="35" required>
<label for="pssNueva2">Repita Nueva Contraseña</label>
<input type= "password" name="pssNueva2" maxlenght="35" required>
<br>
<button  class="btn btn-primary mb-2" type="submit">CAMBIAR</button>
